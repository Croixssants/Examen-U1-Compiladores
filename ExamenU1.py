...
root.configure(background='#70a2f9')

# Crear widgets
input_label = tk.Label(root, text="CADENA:", background='#70a2f9')
input_label.pack()

input_text = tk.Text(root, height=5, width=50)
input_text.pack()

analyze_button = tk.Button(root, text="ANALIZAR", command=analyze_input, background='#5893fa')
analyze_button.pack()

result_label = tk.Label(root, text="RESULTADOS:", background='#70a2f9')
result_label.pack()
